...
class DatabaseManager:
    ...
    def __init__(self, db_name="shipyard.db"):
        ...
        # ✅ MELHORIA: WAL mode melhora performance em leituras/escritas simultâneas
    ...
    def create_tables(self):
        ...
        try:
            ...
            # ✅ CORREÇÃO BUG: commit() ausente após create_tables()
            # Sem isso, as tabelas podiam não ser persistidas em algumas versões do SQLite
            self.conn.commit()

        finally:
            # ✅ CORREÇÃO: cursor sempre fechado
            cursor.close()
